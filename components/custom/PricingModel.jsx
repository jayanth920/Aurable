      ...
      {Lookup.PRICING_OPTIONS.map((pricing, index) => {
        const dailyRemaining =
          pricing.dailyLimit != null
            ? pricing.dailyLimit - (userDetail?.dailyUsed || 0)
            : "Unlimited";
        const weeklyRemaining =
          pricing.weeklyLimit != null
            ? pricing.weeklyLimit - (userDetail?.weeklyUsed || 0)
            : "Unlimited";
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-gray-500">
                <p>
                  ...
                  {pricing.dailyLimit ?? "Unlimited"}
                </p>
              </div>
            </div>

            <div className="mt-6">
              <h4 className="text-3xl font-bold text-center text-indigo-600">
                ${pricing.price}
              </h4>
              {userDetail && (
                <div
