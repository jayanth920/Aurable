...
const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-6 py-3 text-stone-200 [background:var(--bg)] [border-radius:var(--radius)] dark:text-stone-200",
