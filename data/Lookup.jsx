...
export default {
  ...
  SIGNIN_SUBHEADING: 'To use Aurable you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Aurable, you agree to the collection of usage data for analytics.',
